...
public class AdminDatumController {
    ...
    public ApiResult alterUser(@RequestBody Map map){
        ...
        if (old_password != null){      //密码更新
            ...
            String oldPwd = old_password;///MD5.getMd5String(old_password,user.getSalt());
            ...
            String DBPassword = (String) map.get("new_password");///MD5.getMd5String((String) map.get("new_password"),new_salt);
